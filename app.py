...
def proc():
    ...
    if pred == 1:
        resp['inference'] = 'Person has a Probability of developing Chronic Kidney Disease. Please Consult With Your Doctor'
    else:
        resp['inference'] = 'Person does not has Chronic Kidney Disease'
